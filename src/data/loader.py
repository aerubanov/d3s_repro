...
from src.datatypes.tensorlist import TensorList
...
def ltr_collate_stack1(batch):
    ...
    The tensors are stacked at dim=1 to form the batch"""
...
class LTRLoader(torch.utils.data.dataloader.DataLoader):
    ...
    def __init__(self, name, dataset, training=True, batch_size=1,
            ...
            num_workers=0, epoch_interval=1, collate_fn=None, stack_dim=0,
